...
# build mods
${LD_LIBRARY_PATH}/mod_html.so : ${LD_LIBRARY_PATH}/mod_html/mod_html.c
	${GCC} ${FLAGS} -fpic -c ${LD_LIBRARY_PATH}/mod_html/mod_html.c ${MOD_INCLUDES}

mod_html : ${MOD_HTML} 
	${GCC} ${FLAGS} -shared -lc -o ${MOD_HTML}
